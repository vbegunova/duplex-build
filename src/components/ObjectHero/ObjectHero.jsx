        ...
        <Boxes>
          <div>
            ...
            <Description>
              ...
              Гараж розрахований на зберігання двох автомобілів, що забезпечить
              комфортне розташування вашого автопарку. Панорамні вікна дозволять
              вам насолоджуватися захоплюючими видами соснового лісу, що межує з
              вашим подвір'ям, кожен день. Земельна ділянка, що прилегла до
              будинку, облагороджена та відкрита для реалізації будь-яких
              дизайнерських ідей та проектів. Якщо ви шукаєте великий,
              ергономічний будинок в мальовничій місцевості, цей варіант точно
          ...
          <div>
            ...
            <div>
              <ButtonRecord>Записатись на перегляд</ButtonRecord>
              <ButtonCheck>Уточнити наявність</ButtonCheck>
            </div>
          </div>
        </Boxes>
      </Container>
